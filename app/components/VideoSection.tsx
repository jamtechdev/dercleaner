    ...
    <section className="relative h-[500px] w-full overflow-hidden bg-gray-200 md:h-[92vh] hero-section">
      {isYouTube ? (
        ...
        <iframe
          ...
          src={`https://www.youtube.com/embed/${extractYouTubeId(site.videoSection.youtubeUrl)}?autoplay=1&mute=1&loop=1&playlist=${extractYouTubeId(site.videoSection.youtubeUrl)}&controls=1&modestbranding=1`}
