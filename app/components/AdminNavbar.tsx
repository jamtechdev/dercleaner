            ...
            <div className="flex items-center gap-4">
                ...
                <div className="hidden sm:block relative w-64">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full rounded-full border border-slate-200 bg-slate-50 py-2 pl-10 pr-4 text-sm outline-none focus:border-[--brand] focus:ring-1 focus:ring-[--brand]"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
                    <div className="text-right hidden md:block">
                        <p className="text-sm font-bold text-[--brand-cta]">Admin</p>
