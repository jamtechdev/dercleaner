    ...
    <div className="w-full bg-white">
      ...
      <div id="ueber-uns" className="bg-surface-alt scroll-mt-8">
        <div className="flex flex-col md:w-[80%] mx-auto lg:flex-row min-h-[750px] lg:gap-20 uber-uns-img">
          ...
          {/* Right: Text Content */}
          <div className="lg:w-1/2 bg-surface-alt py-12 px-4 md:p-12 xl:p-24 flex flex-col justify-center">
            <h2 className="text-4xl font-bold text-brand mb-6 lg:mb-8">
              {site.aboutSection.title}
            </h2>
            <div className="space-y-3 lg:space-y-6 text-gray-700 leading-relaxed text-sm uber-uns">
